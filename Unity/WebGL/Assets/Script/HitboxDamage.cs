...
public class HitboxDamage : BaseHitbox
{
    ...
    // [Tooltip("Ticks till self destruct (-1 off)")] [SerializeField] protected int _timer = -1;
    ...
    protected void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.gameObject.layer == GameVariables.LayerCreature || other.gameObject.layer == GameVariables.LayerBreakable)
        {
